...
| `Shift + ArrowRight` | Large step up | Global when focus not in text input | Required action |
| `Shift + ArrowLeft` | Large step down | Global when focus not in text input | Required action |
| `Alt + ArrowRight` | Fine step up | Global when focus not in text input | |
| `Alt + ArrowLeft` | Fine step down | Global when focus not in text input | |
...
- `Alt + Left` and `Alt + Right` (history navigation)
