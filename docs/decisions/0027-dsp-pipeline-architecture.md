...
- [ ] Add COOP/COEP headers to webpack-dev-server
- [ ] Add COOP/COEP headers to production deployment
...
- [ ] Extend `dsp-metrics.ts` for pipeline-wide metrics
- [ ] Add metrics collection at each stage
