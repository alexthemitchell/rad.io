...
export function generateAudioSignal(
  ...
  return generateSignalManual(sampleCount, frequency, amplitude, sampleRate, modulation);
}
 ...
 */
export function generateFMSignal(sampleCount: number = 512, carrierOffset: number = 0): Sample[] {
  return generateAudioSignal(
    sampleCount,
    carrierOffset,
    0.5,
    10e6,
 ...
 */
export function generateAMSignal(sampleCount: number = 512, carrierOffset: number = 0): Sample[] {
  return generateAudioSignal(
    sampleCount,
    carrierOffset,
    0.5,
